...
#[cfg(any(
    feature = "deloxide",
    feature = "deloxide_random_default",
    feature = "deloxide_component_based_delays",
    feature = "deloxide_aggressive",
    feature = "deloxide_gentle",
...
pub fn feature_name() -> &'static str {
    #[cfg(feature = "deloxide_random_default")]
    return "deloxide_random_default";

    #[cfg(feature = "deloxide_component_based_delays")]
    return "deloxide_component_based_delays";
    #[cfg(feature = "deloxide_aggressive")]
    return "deloxide_aggressive";
    #[cfg(feature = "deloxide_gentle")]
    return "deloxide_gentle";
    #[cfg(feature = "deloxide_lock_order")]
    return "deloxide_lock_order";
    #[cfg(all(
        feature = "deloxide",
        not(feature = "deloxide_random_default"),
        not(feature = "deloxide_component_based_delays"),
        not(feature = "deloxide_aggressive"),
        not(feature = "deloxide_gentle"),
...
pub fn csv_filename_guaranteed(test_name: &str) -> String {
    format!("guaranteed_deadlock_tests/{}_{}.csv", test_name, feature_name())
}
...
pub fn append_log(filename: &str, tool_flagged: bool, timed_out: bool, elapsed: f64) {
    ...
    writeln!(file, "{}, {}, {:.6}, {}", tool_flagged, timed_out, elapsed, seed)
...
pub fn append_log_no_seed(filename: &str, tool_flagged: bool, timed_out: bool, elapsed: f64) {
    let mut file = OpenOptions::new()
        ...
        .open(filename)
        .expect("Failed to open CSV file");
    writeln!(file, "{}, {}, {:.6}", tool_flagged, timed_out, elapsed)
        .expect("Failed to write to CSV");
}
...
pub fn spawn_with_panic_catch<F>(
    tx: mpsc::Sender<bool>,
    func: F,
) -> thread::JoinHandle<()>
where
