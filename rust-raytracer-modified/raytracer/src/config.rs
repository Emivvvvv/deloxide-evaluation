...
fn test_to_json() {
    let config = Config {
        ...
        objects: vec![Sphere::new(
            Point3D::new(0.0, 0.0, -1.0),
            0.5,
            Material::Lambertian(Lambertian::new(Srgb::new(0.8_f32, 0.3_f32, 0.3_f32))),
        )],
    };
...
pub fn make_cover_world() -> Vec<Sphere> {
    ...
    world.push(Sphere::new(
        ...
        1.0,
        Material::Lambertian(Lambertian::new(Srgb::new(0.4_f32, 0.2_f32, 0.1_f32))),
    ));
    world.push(Sphere::new(
        Point3D::new(4.0, 1.0, 0.0),
        1.0,
        Material::Metal(Metal::new(Srgb::new(0.7_f32, 0.6_f32, 0.5_f32), 0.0)),
    ));
    world
}
